    ...
    async execute(interaction) {
        try {
            ...
            const embed = new Discord.EmbedBuilder()
                ...
                .setFooter({ text: 'Campeonato Brasileiro de Pixelmon 2', iconURL: interaction.client.user.displayAvatarURL({ format: 'png', size: 2048, dynamic: true }) })
                .setTimestamp();
